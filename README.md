# Test automation: Swift translator 
...
├── test-results
├── tests
    ├──singlish_to_sinhala.spec.js    #test file
...
- containing unnecesary special characters
...
-testing if the system autofills the output section when typing input singlish sentence
